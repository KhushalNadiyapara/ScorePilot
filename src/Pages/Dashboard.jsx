...
const Dashboard = () => {
  ...
  return (
<div className='flex items-center justify-center h-screen opacity-100 bg-gradient-to-b via-purple-200 to-pink-100 text-black'>
      <div className='flex flex-row items-center justify-center w-full max-w-4xl bg-opacity-30 rounded-2xl p-10'>
        ...
        <div className='flex-1 flex items-center justify-center'>
          <img
            ...
            className='w-112 h-112 object-cover mr-9 rounded-xl animate-pulse'
          />
        </div>
